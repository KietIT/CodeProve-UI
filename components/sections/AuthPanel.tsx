...
function GoogleIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <path
        fill="rgb(var(--color-googleBlue))"
        d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32v2.77h3.57c2.08-1.92 3.27-4.74 3.27-8.1Z"
      />
      <path
        fill="rgb(var(--color-googleGreen))"
        d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84A11 11 0 0 0 12 23Z"
      />
      <path
        fill="rgb(var(--color-googleYellow))"
        d="M5.84 14.1a6.6 6.6 0 0 1 0-4.2V7.06H2.18a11 11 0 0 0 0 9.88l3.66-2.84Z"
      />
      <path
        fill="rgb(var(--color-googleRed))"
      ...
      >
        ...
        <aside className="relative hidden flex-col justify-between overflow-hidden p-10 lg:flex">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(150deg, rgb(var(--color-blue)) 0%, rgb(var(--color-blueHover)) 55%, rgb(var(--color-cyanInk)) 130%)",
            }}
            aria-hidden="true"
          />
          <div
            className="absolute -left-24 top-1/3 h-72 w-72 rounded-full opacity-50 blur-3xl"
            style={{ background: "rgb(var(--color-cyanBright) / 0.45)" }}
            aria-hidden="true"
          />
