...
export const content = {
  vi: {
    ...
    rubric: {
      ...
      sub: "Mỗi bài làm được chấm trên 6 trục năng lực. Con số bên mỗi trục là mức đóng góp vào điểm cuối - trục càng quan trọng, phần trăm càng cao.",
      axes: [
        {
          name: "Understanding",
          vi: "Hiểu vấn đề",
          weight: "0.25",
          desc: "Bạn hiểu đề và tự giải thích lại được lời giải sau khi nộp - không chỉ chạy đúng là xong.",
        },
        {
          name: "Hypothesis",
          vi: "Đặt giả thuyết",
          weight: "0.22",
          desc: "Bạn tự nêu hướng làm trước khi viết code, thay vì để AI nghĩ hộ.",
        },
        {
          name: "Prompting",
          vi: "Ra lệnh cho AI",
          weight: "0.18",
          desc: "Bạn yêu cầu AI rõ ràng, đúng trọng tâm - không hỏi chung chung hay lặp đi lặp lại.",
        },
        {
          name: "Verification",
          vi: "Kiểm chứng AI",
          weight: "0.15",
          desc: "Bạn phát hiện được khi AI trả lời sai, thay vì tin theo một cách mù quáng.",
        },
        {
          name: "Testing",
          vi: "Kiểm thử",
          weight: "0.10",
          desc: "Bạn tự nghĩ ra các trường hợp để thử, đảm bảo lời giải đúng ở nhiều tình huống.",
        },
        {
          name: "Debugging",
          vi: "Gỡ lỗi",
          weight: "0.10",
          desc: "Bạn tự sửa được khi kết quả sai, không phụ thuộc hoàn toàn vào AI.",
        },
      ],
    },
    workspace: {
  ...
  en: {
    ...
    rubric: {
      ...
      sub: "Every attempt is scored on 6 skill axes. The number on each axis is how much it counts toward your final score - the more important the axis, the higher its percentage.",
      axes: [
        {
          name: "Understanding",
          vi: "Understanding",
          weight: "0.25",
          desc: "You understand the problem and can explain your solution back after submitting - not just make it run.",
        },
        {
          name: "Hypothesis",
          vi: "Hypothesis",
          weight: "0.22",
          desc: "You propose your own approach before writing code, instead of letting the AI think for you.",
        },
        {
          name: "Prompting",
          vi: "Prompting",
          weight: "0.18",
          desc: "You direct the AI clearly and to the point - no vague or repetitive prompts.",
        },
        {
          name: "Verification",
          vi: "Verification",
          weight: "0.15",
          desc: "You catch it when the AI is wrong, instead of trusting the output blindly.",
        },
        {
          name: "Testing",
          vi: "Testing",
          weight: "0.10",
          desc: "You come up with cases to try, making sure the solution holds across situations.",
        },
        {
          name: "Debugging",
          vi: "Debugging",
          weight: "0.10",
          desc: "You fix wrong results yourself, without depending entirely on the AI.",
        },
      ],
    },
    workspace: {
